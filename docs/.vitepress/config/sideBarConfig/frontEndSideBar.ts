  ...
  const frontEnd = [
    {
      ...
      items: [
        ...
        {
          text: "原型和原型链",
          link: "/front-end/javascript/9-原型和原型链.md",
        },
        { text: "事件循环", link: "/front-end/javascript/10-事件循环.md" },
        { text: "包装类", link: "/front-end/javascript/11-包装类.md" },
        {
          text: "常用数组方法",
          link: "/front-end/javascript/12-常用数组方法.md",
        },
        {
          text: "常用对象方法",
          link: "/front-end/javascript/13-常用对象方法.md",
        },
        {
          text: "常用字符串方法",
          link: "/front-end/javascript/14-常用字符串方法.md",
        },
      ],
    },
    {
      ...
      items: [
        ...
        { text: "instanceof", link: "/front-end/js手写实现/instanceof.md" },
        {
          ...
          link: "/front-end/js手写实现/call-apply-bind.md",
        },
      ],
    },
    {
      ...
      items: [
        {
          text: "正则表达式知识点",
          link: "/front-end/正则表达式/1-正则表达式知识点.md",
        },
        {
          text: "正则表达式练习题",
          link: "/front-end/正则表达式/2-正则表达式练习题.md",
        },
        {
          text: "常用的正则表达式",
          link: "/front-end/正则表达式/3-常用的正则表达式.md",
        },
      ],
    },
  ];
